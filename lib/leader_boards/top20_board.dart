...
class Top20Board extends StatefulWidget {

  BrickBreakGame game;

  Top20Board({required this.game, Key? key}) : super(key: key);

  @override
  State<Top20Board> createState() => _Top20BoardState();
}

class _Top20BoardState extends State<Top20Board> {
    ...
    return Container(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          ...
          Column(mainAxisAlignment: MainAxisAlignment.center,
            children: [
            Text('${leaderBoard['points'] ?? 0}',style: TextStyle(fontSize: 15, fontWeight: FontWeight.w400, color: Colors.orange.shade200)),
          ],),
          // Column(
