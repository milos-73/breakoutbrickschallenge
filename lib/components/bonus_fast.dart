...
class BonusFast extends BodyComponent<BrickBreakGame> with ContactCallbacks{

  final Size size;
  final Vector2 position;

  BonusFast({required this.size, required this.position});
  ...
  Future<void> onLoad() async{
    await super.onLoad();
    final sprite = await gameRef.loadSprite('bonus/bonus1.png');
    renderBody = false;
