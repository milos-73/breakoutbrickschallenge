...
class BonusPowerBall extends BodyComponent<BrickBreakGame> with ContactCallbacks{

  final Size size;
  final Vector2 position;

  BonusPowerBall({required this.size, required this.position});
  ...
  Future<void> onLoad() async{
    await super.onLoad();
    final sprite = await gameRef.loadSprite('bonus/bonus5.png');
    renderBody = false;
  ...
  void beginContact(Object other, Contact contact){
    if (other is Paddle){
      ...
      destroy = true;
      gameRef.cannonBallStatus = 1;
      gameRef.powerBallBonus = 1;
