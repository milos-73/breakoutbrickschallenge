...
class BonusCannon extends BodyComponent<BrickBreakGame> with ContactCallbacks{

  final Size size;
  final Vector2 position;

  BonusCannon({required this.size, required this.position});
  ...
  Future<void> onLoad() async{
    await super.onLoad();
    final sprite = await gameRef.loadSprite('bonus/bonus4.png');
    renderBody = false;
  ...
  void beginContact(Object other, Contact contact){
    if (other is Paddle){
      ...
      destroy = true;
      gameRef.gunState = GunState.through;
      print('------gameRef.gunState BONUS------: ${gameRef.gunState}');
    }
