      ...
      child: Column(
        ...
        children: [
         ...
         SizedBox(height: (widget.game.camera.viewport.canvasSize?.y)!/50,),
          ...
          SizedBox(height: (widget.game.camera.viewport.canvasSize?.y)!/50,),
        Center(child: widget.game.prefs.getString('customUserProfileName') != null ? Text('Last login: ${widget.game.prefs.getString('customUserProfileName')}',style: TextStyle(fontSize: 14,color: Colors.white),)
            : Text('Last login: Not logged in yet',style: TextStyle(fontSize: 14,color: Colors.white),),)
      ],
      ),
    );
  }
